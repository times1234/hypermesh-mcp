...
def generate_plain_tetra_tcl(
    ...
    lines = [
        ...
        '        mcp_delete_elems $surface_backup_ids',
        '        set kept_surface_shell_count $shell_count',
        '        continue',
        '    }',
        ...
        '    if {[llength $comp_elems] == 0} { puts "MCP_PT_WARN solid=$target_solid no_tetra_after_tetmesh_keep_surface_mesh=1"; mcp_delete_elems $surface_backup_ids; set kept_surface_shell_count $shell_count; continue }',
